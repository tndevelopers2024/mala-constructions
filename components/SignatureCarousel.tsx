...
export default function SignatureCarousel() {
  return (
    <div className="relative w-full h-full group rounded-2xl overflow-hidden shadow-2xl border border-gold/10">
      ...
      {/* Floating Info Badge */}
      <div className="absolute top-6 left-6 z-20">
        <div className="bg-charcoal/40 backdrop-blur-md border-l-4 border-gold px-5 py-3 rounded-r-xl">
          <p className="text-gold text-[10px] uppercase tracking-[0.3em] font-bold mb-1">
            Project Highlights
          </p>
          <h4 className="text-warm-white font-serif text-lg font-bold">
            Premium Living
          </h4>
        </div>
      </div>
