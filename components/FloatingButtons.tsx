  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-4">
      ...
      <a
        ...
        className="w-12 h-12 bg-charcoal text-gold rounded-full flex items-center justify-center shadow-lg hover:bg-gold hover:text-charcoal transition-all duration-300 hover:scale-110 group border border-gold/20"
        aria-label="Call us"
        title="Call us"
      >
        <svg
