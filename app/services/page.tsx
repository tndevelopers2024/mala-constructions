...
export const metadata: Metadata = {
  title: "Our Services | MALA Constructions",
  description: "Explore MALA Constructions' comprehensive services — residential, commercial, renovation, infrastructure, maintenance, and luxury stays in Chennai.",
  openGraph: {
